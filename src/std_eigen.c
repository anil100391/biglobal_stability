 ...
 * solve the eigenvalues problem Aq = wq. This function has been obtained
...
//    ierr = MatGetVecs(arg->D2x,NULL,&xr);CHKERRQ(ierr);
//    ierr = MatGetVecs(arg->D2x,NULL,&xi);CHKERRQ(ierr);
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
